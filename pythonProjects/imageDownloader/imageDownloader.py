import bs4       #download beautiful soup
import requests
import os
...
def image_downloader(extension):
    ...
    url = 'http://imgur.com/search/score/all?q=' + search
...
search = input('Enter desired search keyword(s): ')
...
if downloaded == 0:
    ...
    print('All ' + str(downloaded) + ' pictures successfully downloaded.')